      ...
      <div className="bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-xl shadow-lg text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <button
            ...
            className="flex items-center justify-center gap-2 p-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-semibold"
          >
            <FolderIcon /> 모든 단어 ({appData.words.length})
          </button>
          <button
            onClick={() => startStudy("starred")}
            className="flex items-center justify-center gap-2 p-4 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 transition-colors font-semibold"
          >
            <StarIcon filled /> 별표 단어 ({starredWordsCount})
          </button>
          <button
            onClick={() => startStudy("unassigned")}
            className="flex items-center justify-center gap-2 p-4 bg-slate-600 text-white rounded-lg hover:bg-slate-700 transition-colors font-semibold"
          >
            <FolderIcon /> 미분류 (
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-xl shadow-lg relative">
        ...
        <button
          onClick={resetStudy}
          className="absolute top-4 right-6 text-sm text-slate-400 hover:text-slate-200"
        >
          폴더 선택으로
        </button>
